          ...
          {dashboardCards.map((card) => (
            ...
            >
              ...
              <div className="relative z-10 ml-5 flex items-center justify-center">
                ...
                <span className="absolute -top-1 -right-2 bg-pink-500 text-white text-[10px] rounded-full w-4 h-4 flex items-center justify-center font-semibold shadow-sm group-hover:scale-110 transition-transform duration-300">
                  {card.count}
                </span>
              </div>

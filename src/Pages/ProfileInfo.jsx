...
const ProfileInfo = () => {
  const [profileData, setProfileData] = useState({
    ...
    likesDislikes: 'Watching movies in theatre',
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white">
      ...
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-xl font-bold text-gray-800">Aalam</h1>
        </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Likes/Dislikes */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Likes/Dislikes</label>
            <input
              type="text"
              value={profileData.likesDislikes}
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex">
              <select className="px-3 py-2 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50">
